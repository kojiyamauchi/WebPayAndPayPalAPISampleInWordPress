<?php
/*
Template Name: PayPal Order Complete Page
*/
?>
    ...
    */
    ...
    if ($ack == 'SUCCESS' || $ack == 'SUCCESSWITHWARNING') {
      ...
      //Debug
        ...
        echo '<h1>呼び出し・決済処理に失敗しました。</h1>
        <h2 class="tastcomplete">トップ画面に戻り、再度操作をやり直して下さい。</h2>';
        //Detailed Error Message.
        echo '<h2></br>詳細メッセージを確認して下さい。</h2>'.$ErrorLongMsg;
        //Short Error Message
        echo '<h2></br>ショートエラーメッセージ</h2>'.$ErrorShortMsg;
        //Error Code.
        echo '<h2></br>エラーコード</h2>'.$ErrorCode;
        //Error Severity Code
        echo '<h2></br>重大なエラーコード</h2>'.$ErrorSeverityCode;
        //Debug
        print_r($reasonCode);
    }
}
