<?php
/*
Template Name: PayPal Review Page
*/
?>
<?php
/*==================================================================
    ...
    */
    ...
    if ($ack == 'SUCCESS' || $ack == 'SUCESSWITHWARNING') {
        ...
        */
        ...
        echo 'Error Code: '.$ErrorCode;echo 'Error Severity Code: '.$ErrorSeverityCode;
    }
}
...
<table>
	<tbody>
		...
		<tr>
			<th>お支払い金額:</th>
			<td>&yen;<?= $_SESSION['Payment_Amount'] ?></td>
		</tr>
	<tbody>
</table>
<form action='<?php bloginfo('url'); ?>/paypalordercomplete/' METHOD='POST'>
<input  class="btn btnSend" type="submit" value="支払いを確定する"/>
</form>
</div>
<?php get_footer(); ?>
